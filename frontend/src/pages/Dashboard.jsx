...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <nav className="bg-#10B981  shadow-sm">
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <button 
                    onClick={() => handleComingSoon('Skills')}
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <button 
                    onClick={() => handleComingSoon('Career Goals')}
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <button 
                    onClick={() => handleComingSoon('Job Applications')}
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <button 
                onClick={() => handleComingSoon('Resume Review')}
                className="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus:outline-none"
              >
                <div className="flex-shrink-0">
                ...
                <div className="flex-1 min-w-0 text-left">
                  ...
                  <p className="text-sm text-gray-500">Review with AI</p>
                </div>
              </button>

              <button 
                onClick={() => handleComingSoon('Interview Prep')}
                className="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus:outline-none"
              >
                <div className="flex-shrink-0">
              ...
              <button 
                onClick={() => handleComingSoon('Career Advice')}
                className="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus:outline-none"
              >
                <div className="flex-shrink-0">
                ...
                <div className="flex-1 min-w-0 text-left">
                  <p className="text-sm font-medium text-gray-900">Career Advice</p>
